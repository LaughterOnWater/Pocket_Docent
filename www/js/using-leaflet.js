...
//Markers and Bound Popups For Layer Seventeen and Closer
		...
		LayerSeventeen.addLayer(marker_entrance);
...
//Markers and Bound Popups For Layer Eighteen and Closer
		...
		LayerEighteen.addLayer(marker_gator_enclosure);
		...
		LayerEighteen.addLayer(marker_deer_turkey_enclosure);
		...
		LayerEighteen.addLayer(marker_opossums);
		...
		LayerEighteen.addLayer(marker_groundhog);
		...
		LayerEighteen.addLayer(marker_exercise_yard);
		...
		LayerEighteen.addLayer(marker_barn);
		...
		LayerEighteen.addLayer(marker_bear_enclosure);
		...
		LayerEighteen.addLayer(marker_eagle_enclosure);
		...
		LayerEighteen.addLayer(marker_bobcat_enclosure);
		...
		LayerEighteen.addLayer(marker_unused_enclosure);
		...
		LayerEighteen.addLayer(marker_beaver_enclosure);
